      ...
      <Form method="POST">
        ...
        <div className="relative mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          {!position.latitude && !position.longitude && (
            <span className="md:top[5px] top[3px] right-[3px] z-50 md:right-[5px]">
              <Button
                disabled={isLoadingAddress}
                type="small"
                onClick={e => {
        ...
        <div className="mb-7 flex items-center gap-5 sm:mb-12">
          <input
...
export async function action({ request }) {
  ...
  //if everything is ok, create a new order adn redirect
